          ...
          function($scope) {
            $scope.time_change = function() {
              if (angular.isDefined($scope.ngModel) && angular.isDefined($scope.time)) {
             	 var Hour = moment($scope.time).format('HH'); 
             	 var Minutes = moment($scope.time).format('mm'); 
             	 var Hourset = moment($scope.ngModel).set('hours', Hour);                
                 $scope.ngModel = moment(Hourset).set('minute', Minutes).format();
              }
            }
          }
        ],
